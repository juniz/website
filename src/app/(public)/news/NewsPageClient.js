...
export default function NewsPageClient({ initialNews = [] }) {
        ...
        <div className="container-site">
          <nav aria-label="Breadcrumb" style={{ marginBottom: '1rem' }}>
            <ol style={{ display: 'flex', alignItems: 'center', gap: '0.375rem', listStyle: 'none', fontSize: '0.75rem', color: 'var(--color-primary-200)' }}>
              ...
              <li aria-current="page" style={{ color: 'var(--color-primary-50)' }}>Berita & Informasi</li>
            </ol>
          </nav>
          ...
          <p style={{ color: 'var(--color-primary-200)', fontSize: '0.9375rem' }}>
            Artikel terbaru dari tim medis dan redaksi RS Bhayangkara Nganjuk
          </p>
        </div>
      </section>
