...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const ogImageUrl = seo?.ogImage || seo?.og_image
    ? getOgImageUrl((seo?.ogImage || seo?.og_image) as string, baseUrl)
    : `${baseUrl}/og-home.jpg`;
...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* Hero — above-the-fold, CSS-only entrance */}
      ...
      {/* Final CTA Banner (Element 10) */}
      <ScrollReveal variant="zoom" threshold={0.06}>
        <CTABanner />
      </ScrollReveal>
