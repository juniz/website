...
function PrimaryBtn({ children, disabled, onClick, type = 'button', style: extra = {} }) {
  return (
    <button
      type={type}
      disabled={disabled}
        ...
        {selectedDate && (
          <div style={{ borderTop: '1px solid var(--color-neutral-100)', paddingTop: '1.75rem' }}>
            ...
            {isLoadingSchedules ? (
              ...
              <div className="lf-schedule-list" style={{ display: 'flex', flexDirection: 'column', gap: '0.625rem', marginTop: '1rem' }}>
