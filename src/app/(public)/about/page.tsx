...
const FALLBACK_PROFILE = {
  ...
  accreditation_certificate_url: null as string | null,
};
...
export default async function AboutPage() {
  ...
  // Cast visiMisi.misi which can be string or parsed array
  const missions = Array.isArray(visiMisi.misi) 
    ? visiMisi.misi 
    : typeof visiMisi.misi === 'string'
      ? JSON.parse(visiMisi.misi)
      : [];
  ...
  return (
    <>
      ...
      <PageHero
        ...
        title={profile.header_title || 'Tentang Kami'}
        subtitle={profile.header_subtitle || ''}
      />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <section aria-labelledby="visi-heading" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }} className="visi-grid">
            ...
            <div style={{ background: '#fff', border: '1px solid var(--color-neutral-200)', borderRadius: '12px', padding: '1.5rem' }}>
              ...
              <ul style={{ fontSize: '0.875rem', color: 'var(--color-neutral-600)', lineHeight: 1.65, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.5rem', paddingLeft: 0 }}>
