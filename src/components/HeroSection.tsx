...
import { Hospital, ShieldCheck, Award } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Cinematic gradient overlay (desktop) — deep_space_blue #023047 */}
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'linear-gradient(to right, rgba(2, 48, 71, 0.95) 0%, rgba(2, 48, 71, 0.7) 40%, rgba(2, 48, 71, 0.3) 100%)',
        }} className="hero-overlay-desktop" />

        {/* Solid overlay (mobile) — deep_space_blue #023047 */}
        <div style={{
          position: 'absolute',
          inset: 0,
      ...
      <style>{`
        ...
        .hero-btn-primary:hover {
          ...
          box-shadow: 0 12px 40px rgba(208, 149, 0, 0.45);
        }
