...
function PartnerLogo({ partner }: PartnerLogoProps) {
  const logoUrl = partner.logo_url || partner.imageUrl || partner.logoUrl;
  const webUrl = partner.website_url || partner.link;
...
export default function PartnerSection({ data = [] }: PartnerSectionProps) {
